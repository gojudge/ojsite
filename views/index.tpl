...
{{{asset "sass/index.scss"}}}
        <div class="index-info-box">
          ...
          <p>Ojsite项目地址 <a href="https://github.com/duguying/ojsite">https://github.com/duguying/ojsite</a><br>Judger项目地址 <a href="https://github.com/duguying/judger">https://github.com/duguying/judger</a></p>
        </div>
